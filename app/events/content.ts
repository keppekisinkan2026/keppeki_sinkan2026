...
export const welcomeEvents: WelcomeEvent[] = [
  ...
  { id: "ev17", date: "4/17", dates: eventDates("2026-04-17"), title: "上映会", description: "劇団ケッペキの過去公演を上演します！「劇団ケッペキってどんな舞台を作るんだろう.....?」「今までどんな演目を上演したんだろう」と気になっているそこのアナタ。タダで観劇できるチャンスです。", position: { top: "59%", left: "63%", width: "12.0%", height: "12.0%" } },
